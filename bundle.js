...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = function (_React$Component) {
	    ...
	    function Menu(props) {
	        ...
	        _this.handleHighlightClick = _this.handleHighlightClick.bind(_this);
	        _this.toggleSelected = _this.toggleSelected.bind(_this);
	        return _this;
	    }

	    _createClass(Menu, [{
	        key: 'handleHighlightClick',
	        value: function handleHighlightClick() {
	        ...
	        key: 'toggleSelected',
	        value: function toggleSelected(entry) {
	            var newState;
	        ...
	        value: function render() {
	            return _react2.default.createElement(Toggles, { handleHighlightClick: this.handleHighlightClick, toggleSelected: this.toggleSelected, data: this.state });
	        }
	    }]);
	...
	var Toggles = function (_React$Component2) {
	    _inherits(Toggles, _React$Component2);

	    function Toggles(props) {
	        _classCallCheck(this, Toggles);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Toggles).call(this, props));
	    }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'ui toggle checkbox axis' },
	                            _react2.default.createElement(
	                                'label',
	                                null,
	                                'Use shared y-axis'
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: "ui toggle checkbox sic " + this.isChecked() },
	                            _react2.default.createElement(
	                                'label',
	                                null,
	                                'Highlight all'
	                            ),
	                            _react2.default.createElement('input', { onClick: this.props.handleHighlightClick, type: 'checkbox', name: 'public' })
	                        ),
	                        _react2.default.createElement('div', { className: 'ui hidden divider' }),
	                        _react2.default.createElement(
	                            'div',
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'buttoncontainer ui segment' },
	                                _react2.default.createElement(
	                                    'h4',
	                                    { className: 'ui header' },
	                                    'Hover to highlight'
	                                ),
	                                _react2.default.createElement(LabelControls, { data: this.props.data, toggleSelected: this.props.toggleSelected })
	                            )
	                        )
	                    )
	                )
	...
	var LabelControls = function (_React$Component3) {
	    _inherits(LabelControls, _React$Component3);

	    function LabelControls(props) {
	        _classCallCheck(this, LabelControls);

	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(LabelControls).call(this, props));

	        _this3.makeToolTip = _this3.makeToolTip.bind(_this3);
	        return _this3;
	    }

	    _createClass(LabelControls, [{
	        key: 'makeToolTip',
	        value: function makeToolTip(key) {
	        ...
	        value: function render() {
	            ...
	            var keys = Object.keys(SIC_DICT);
	            var makeToolTip = this.makeToolTip;
	            var labels = keys.map(function (key, i) {
	                return _react2.default.createElement(ButtonLabel, { toggleSelected: _this4.props.toggleSelected, data: _this4.props.data, sic: key, key: key });
	            });
	            return _react2.default.createElement(
	                'div',
	                null,
	...
	var ButtonLabel = function (_React$Component4) {
	    _inherits(ButtonLabel, _React$Component4);

	    function ButtonLabel(props) {
	        _classCallCheck(this, ButtonLabel);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ButtonLabel).call(this, props));
	    }
	    ...
	    _createClass(ButtonLabel, [{
	        ...
	        value: function render() {
	            ...
	            var key = this.props.sic;
	            var color = SIC_DICT[key].color[1];
	            return _react2.default.createElement(
	                'div',
	                { key: key, className: 'item' },
	                _react2.default.createElement('button', { className: "ui horizontal small circular " + this.getStyle() + color + " label", 'data-key': key, onClick: function onClick() {
	                        return _this6.handleClick();
	                    } }),
	                ' ',
	                this.makeToolTip(key)
	            );
	        }
	    }]);
	...
	_reactDom2.default.render(_react2.default.createElement(Menu, null), document.getElementById('page'));
